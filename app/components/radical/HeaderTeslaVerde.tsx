...
const HeaderTeslaVerde = () => {
  ...
  return (
    <header className="fixed top-0 w-full bg-bg-primary/80 backdrop-blur-md border-b border-green-primary/10 z-50 transition-smooth">
        ...
        <div className="hidden md:flex items-center gap-8">
          {navItems.map((item) => (
            <a 
              key={item.href} 
              href={item.href} 
              className="text-small text-secondary hover:text-green-primary transition-fast font-medium"
            >
              {item.label}
            </a>
          ))}
      ...
      {/* Mobile menu */}
      {isMenuOpen && (
        <div className="md:hidden bg-bg-card border-t border-green-primary/20">
          <div className="container py-4 space-y-4">
            {navItems.map((item) => (
              <a 
                key={item.href} 
                href={item.href} 
                className="block text-body text-secondary hover:text-green-primary transition-fast"
...
export const HeaderMinimalTesla = () => {
  return (
    <header className="fixed top-0 w-full bg-bg-primary/90 backdrop-blur-sm z-50">
      <div className="container h-14 flex items-center justify-between">
        <a href="/" className="flex items-center gap-2 hover:text-green-primary transition-fast">
        ...
        <div className="flex items-center gap-6">
          <a href="/ecosistema" className="hidden md:block text-small text-secondary hover:text-green-primary transition-fast">
            Ecosistema
          </a>
          <a href="/impacto" className="hidden md:block text-small text-secondary hover:text-green-primary transition-fast">
            Impacto
          </a>
...
export default HeaderTeslaVerde